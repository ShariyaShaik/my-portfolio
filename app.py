...
#   .hero-image { width: 250px; height: 315px; }             /* was 400x400 */
# </style>
# """, unsafe_allow_html=True)
...
<div id="about" class="main-content">
  <section class="hero-section">
    <div class="hero-image-container">
      <img src="https://raw.githubusercontent.com/ShariyaShaik/portfolio/refs/heads/main/image.jpeg"alt="Sathi Lakshmi Narayana Reddy" class="hero-image">
    </div>
    <div class="hero-content">
...
st.markdown("""<div style="align:center" class="cta-container" style="justify-content: flex-start;">
        <a style="text-decoration:none" href="#contact" onclick="scrollToSection('contact'); return false;" class="cta-button">Get In Touch</a>
        <a style="text-decoration:none" href="https://drive.google.com/file/d/1fIFsWWEp7RFNmpUcVpPkSmyk8lvAfGad/view?usp=drive_link" target="_blank" class="cta-button">Check Out My Resume</a>
        <a style="text-decoration:none" href="https://github.com/SathiLNR" target="_blank" class="cta-button">View GitHub</a>
        <a style="text-decoration:none" href="https://www.linkedin.com/in/sathi-lakshmi-narayana-reddy/" target="_blank" class="cta-button">LinkedIn Profile</a>
      </div>""",unsafe_allow_html=True)
st.markdown("<br>",unsafe_allow_html=True)
col1, col2, col3, col4 = st.columns(4)
with col1:
...
with col2:
    st.markdown("""
    <a style="text-decoration:none" href="https://leetcode.com/u/SathiLNR/"><div class="stat-card">
...
with col4:
    st.markdown("""
    <a style="text-decoration:none" href="https://www.hackerrank.com/profile/sathireddy">
    <div class="stat-card">
        <div class="stat-number"style="font-size: 2rem;">Hackerrank</div>
        <div class="stat-label">5★ in Python</div>
        <div class="stat-label">4★ in Java</div>
...
<div class="content-card">
    ...
    <div class="card-description">
        ...
        <a href="https://drive.google.com/file/d/certificate_link" target="_blank" style="color: #00d4ff; text-decoration: none; font-weight: 600; margin-top: 10px; display: inline-block;">View Certificate →</a>
    </div>
</div>
<div class="content-card">
    <h3 class="card-title">AIML Intern</h3>
...
with col1:
    ...
    <div class="content-card">
        ...
        <a href="https://github.com/SathiLNR" target="_blank" style="color: #00d4ff; text-decoration: none; font-weight: 600; margin-top: 15px; display: inline-block;">View on GitHub →</a>
    </div>
...
with col2:
    ...
    <div class="content-card">
        ...
        <a href="https://www.linkedin.com/in/sathi-lakshmi-narayana-reddy/" target="_blank" style="color: #00d4ff; text-decoration: none; font-weight: 600; margin-top: 15px; display: inline-block;">View on LinkedIn →</a>
    </div>
...
certifications = [
    ("Certified System Administrator - ServiceNow", "2025", "https://drive.google.com/certificate"),
    ("Certified Application Developer - ServiceNow", "2025", "https://drive.google.com/certificate"),
    ("Programming, Data Structures and Algorithms using Python - NPTEL", "2024", "https://archive.nptel.ac.in/certificate"),
    ("Google AI Essentials - Google, Coursera", "2024", "https://www.coursera.org/certificate"),
    ("Java (Basic) Certificate - HackerRank", "2025", "https://www.hackerrank.com/certificates/"),
    ("Python (Basic) Certificate - HackerRank", "2025", "https://www.hackerrank.com/certificates/"),
    ("SQL (Basic) Certificate - HackerRank", "2025", "https://www.hackerrank.com/certificates/")
]
...
<div class="contact-container">
    <div class="contact-info">
        ...
        <div class="contact-links">
            <a style="text-decoration:none" href="mailto:sathireddy@example.com" class="contact-link">Email</a>
            <a style="text-decoration:none" href="tel:+919876543210" class="contact-link">Phone</a>
            <a style="text-decoration:none" href="https://www.linkedin.com/in/sathi-lakshmi-narayana-reddy/" target="_blank" class="contact-link">LinkedIn</a>
            <a style="text-decoration:none" href="https://github.com/SathiLNR" target="_blank" class="contact-link">GitHub</a>
            <a style="text-decoration:none" href="https://hackerrank.com/sathireddy" target="_blank" class="contact-link">HackerRank</a>
        </div>
        <p style="color: #808080; font-size: 1.05rem; margin-top: 30px;">
            Resident in Tirupati, Andhra Pradesh, India
        </p>
